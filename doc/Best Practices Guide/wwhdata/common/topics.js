...
else if (Guidewire_TopicMatch(TOPIC,"Guidewire PolicyCenter\u00ae") && Guidewire_FMSourceFileMatch(SRCFILE,"cover-bestpractice.html") ) { return "cover-bestpractice.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Avoid Doubly Nested Loop Constructs") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.34.html") ) { return "bp-gosu.6.34.html";}
else if (Guidewire_TopicMatch(TOPIC,"Pull Up Multiple Performance Intensive Method Calls") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.35.html") ) { return "bp-gosu.6.35.html";}
else if (Guidewire_TopicMatch(TOPIC,"Be Wary of Dot Notation with Object Access Paths") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.36.html") ) { return "bp-gosu.6.36.html";}
else if (Guidewire_TopicMatch(TOPIC,"Avoid Code that Incidentally Queries the Database") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.37.html") ) { return "bp-gosu.6.37.html";}
else if (Guidewire_TopicMatch(TOPIC,"Use Comparison Methods to Filter Queries") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.38.html") ) { return "bp-gosu.6.38.html";}
else if (Guidewire_TopicMatch(TOPIC,"Use Count Properties on Query Builder Results and Find Queries") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.39.html") ) { return "bp-gosu.6.39.html";}
else if (Guidewire_TopicMatch(TOPIC,"Use Activity Pattern Codes Instead of Public IDs in Comparisons") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.40.html") ) { return "bp-gosu.6.40.html";}
else if (Guidewire_TopicMatch(TOPIC,"Do Not Instantiate Plugins for Every Execution") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.41.html") ) { return "bp-gosu.6.41.html";}
else if (Guidewire_TopicMatch(TOPIC,"Gosu Best Practices Checklist") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-gosu.6.42.html") ) { return "bp-gosu.6.42.html";}
else if (Guidewire_TopicMatch(TOPIC,"Upgrade Best Practices") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-upgrade.7.1.html") ) { return "bp-upgrade.7.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Upgradability Best Practices") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-upgrade.7.2.html") ) { return "bp-upgrade.7.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Add Minor Changes Directly to Base Files") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-upgrade.7.3.html") ) { return "bp-upgrade.7.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Copy Base Files to Add Major Changes") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-upgrade.7.4.html") ) { return "bp-upgrade.7.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Copy Base Functions to Make Major Changes") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-upgrade.7.5.html") ) { return "bp-upgrade.7.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Switching From Minor to Major Changes") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-upgrade.7.6.html") ) { return "bp-upgrade.7.6.html";}
else if (Guidewire_TopicMatch(TOPIC,"Upgrade Best Practices Checklist") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-upgrade.7.7.html") ) { return "bp-upgrade.7.7.html";}
