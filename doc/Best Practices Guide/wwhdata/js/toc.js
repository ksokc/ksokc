...
C=B.fN("Use Existing Display Keys Whenever Possible","8#2284115");
...
C=B.fN("Avoid Doubly Nested Loop Constructs","56");
C=B.fN("Pull Up Multiple Performance Intensive Method Calls","57");
C=B.fN("Be Wary of Dot Notation with Object Access Paths","58");
C=B.fN("Avoid Code that Incidentally Queries the Database","59");
C=B.fN("Use Comparison Methods to Filter Queries","60");
C=B.fN("Use Count Properties on Query Builder Results and Find Queries","61");
C=B.fN("Use Activity Pattern Codes Instead of Public IDs in Comparisons","62");
C=B.fN("Do Not Instantiate Plugins for Every Execution","63");
B=A.fN("Gosu Best Practices Checklist","64");
A=P.fN("Upgrade Best Practices","65");
B=A.fN("Upgradability Best Practices","66");
C=B.fN("Add Minor Changes Directly to Base Files","67");
C=B.fN("Copy Base Files to Add Major Changes","68");
C=B.fN("Copy Base Functions to Make Major Changes","69");
C=B.fN("Switching From Minor to Major Changes","70");
B=A.fN("Upgrade Best Practices Checklist","71");
}
