...
x.t("effdatedbranchtype","relevant");
...
x.t("mydenormcolumn","policycenter");
x.t("note","possible");
x.t("note","guidewire");
x.t("column","exist");
x.t("column","table");
