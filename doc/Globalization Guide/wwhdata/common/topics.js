...
else if (Guidewire_TopicMatch(TOPIC,"Working with a Localized Studio") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_studio.09.1.html") ) { return "localization_studio.09.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Localization in the Guidewire Studio User Interface") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_studio.09.2.html") ) { return "localization_studio.09.2.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Setting Default Width for Input Field Labels") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_studio.09.6.html") ) { return "localization_studio.09.6.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Configuring Name Information") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.15.1.html") ) { return "name_config.15.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Names in PolicyCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.15.2.html") ) { return "name_config.15.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Understanding Global Names") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.15.3.html") ) { return "name_config.15.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Modal PCF Files and Name Configuration") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.15.4.html") ) { return "name_config.15.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Name Owners") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.15.5.html") ) { return "name_config.15.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"NameFormatter Class") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.15.6.html") ) { return "name_config.15.6.html";}
else if (Guidewire_TopicMatch(TOPIC,"NameOwnerFieldId Class") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.15.7.html") ) { return "name_config.15.7.html";}
else if (Guidewire_TopicMatch(TOPIC,"Working with Kanji Fields") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_kanji_fields.16.1.html") ) { return "localization_kanji_fields.16.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Enabling Indexes for Kanji Fields") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_kanji_fields.16.2.html") ) { return "localization_kanji_fields.16.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Working with the Japanese Imperial Calendar") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_JIC.17.1.html") ) { return "localization_JIC.17.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"The Japanese Imperial Calendar Date Widget") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_JIC.17.2.html") ) { return "localization_JIC.17.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Japanese Dates") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_JIC.17.3.html") ) { return "localization_JIC.17.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Setting the Japanese Imperial Calendar as the Default for a Region") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_JIC.17.4.html") ) { return "localization_JIC.17.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Setting Fields to Display the Japanese Imperial Calendar") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_JIC.17.5.html") ) { return "localization_JIC.17.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Working with Japanese Imperial Dates in Gosu") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_JIC.17.6.html") ) { return "localization_JIC.17.6.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Configuring Currencies") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.1.html") ) { return "currency.19.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"PolicyCenter Base Configuration Currencies") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.2.html") ) { return "currency.19.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Working with Currency Typecodes") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.3.html") ) { return "currency.19.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Monetary Amounts in the Data Model and in Gosu") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.4.html") ) { return "currency.19.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Monetary Amount Data Type") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.5.html") ) { return "currency.19.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Currency-related Configuration Parameters") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.6.html") ) { return "currency.19.6.html";}
else if (Guidewire_TopicMatch(TOPIC,"Setting the Default Application Currency") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.7.html") ) { return "currency.19.7.html";}
else if (Guidewire_TopicMatch(TOPIC,"Choosing a Rounding Mode") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.8.html") ) { return "currency.19.8.html";}
else if (Guidewire_TopicMatch(TOPIC,"Setting the Currency Display Mode") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.19.9.html") ) { return "currency.19.9.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Geographic Data") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_jurisdictions.20.1.html") ) { return "localization_jurisdictions.20.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Working with Country Typecodes") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_jurisdictions.20.2.html") ) { return "localization_jurisdictions.20.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Country Address Formats") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_jurisdictions.20.3.html") ) { return "localization_jurisdictions.20.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Setting the Default Application Country") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_jurisdictions.20.4.html") ) { return "localization_jurisdictions.20.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Jurisdiction Information") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_jurisdictions.20.5.html") ) { return "localization_jurisdictions.20.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring State Information") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_jurisdictions.20.6.html") ) { return "localization_jurisdictions.20.6.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Zone Information") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_jurisdictions.20.7.html") ) { return "localization_jurisdictions.20.7.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Address Information") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.1.html") ) { return "address_config.21.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Addresses in PolicyCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.2.html") ) { return "address_config.21.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Understanding Global Addresses") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.3.html") ) { return "address_config.21.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Address Modes in Page Configuration") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.4.html") ) { return "address_config.21.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Address Owners") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.5.html") ) { return "address_config.21.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"AddressOwnerFieldId Class") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.6.html") ) { return "address_config.21.6.html";}
else if (Guidewire_TopicMatch(TOPIC,"Address Autocompletion and Autofill") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.7.html") ) { return "address_config.21.7.html";}
else if (Guidewire_TopicMatch(TOPIC,"Example: Adding a Country with a New Address Field") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.21.8.html") ) { return "address_config.21.8.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Phone Information") && Guidewire_FMSourceFileMatch(SRCFILE,"phone_config.22.1.html") ) { return "phone_config.22.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Working with Phone Configuration Files") && Guidewire_FMSourceFileMatch(SRCFILE,"phone_config.22.2.html") ) { return "phone_config.22.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Setting Phone Configuration Parameters") && Guidewire_FMSourceFileMatch(SRCFILE,"phone_config.22.3.html") ) { return "phone_config.22.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Phone Number PCF Widget") && Guidewire_FMSourceFileMatch(SRCFILE,"phone_config.22.4.html") ) { return "phone_config.22.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Converting Phone Numbers from Previous Formats") && Guidewire_FMSourceFileMatch(SRCFILE,"phone_config.22.5.html") ) { return "phone_config.22.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Linguistic Search and Sort") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.1.html") ) { return "localization_sorting.23.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Linguistic Search and Sort of Character Data") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.2.html") ) { return "localization_sorting.23.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Effect of Character Data Storage Type on Searching and Sorting") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.3.html") ) { return "localization_sorting.23.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Searching and Sorting in Configured Languages") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.4.html") ) { return "localization_sorting.23.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Search in the PolicyCenter Database") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.5.html") ) { return "localization_sorting.23.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Searching and the Oracle Database") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.6.html") ) { return "localization_sorting.23.6.html";}
else if (Guidewire_TopicMatch(TOPIC,"Searching and the SQL Server Database") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.7.html") ) { return "localization_sorting.23.7.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring Sort in the PolicyCenter Database") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.23.8.html") ) { return "localization_sorting.23.8.html";}
else if (Guidewire_TopicMatch(TOPIC,"Configuring National Field Validation") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_fieldvalidation.24.1.html") ) { return "localization_fieldvalidation.24.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Understanding National Field Validation") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_fieldvalidation.24.2.html") ) { return "localization_fieldvalidation.24.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Localizing Field Validators for National Field Validation") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_fieldvalidation.24.3.html") ) { return "localization_fieldvalidation.24.3.html";}
